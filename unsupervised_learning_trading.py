...
# Indicators: Garman-Klass Volatility, RSI, Bollinger Bands, ATR, MACD, Dollar Volume
...
# Join rolling factors to main features dataframe
...
# Pre-define centroids based on target RSI values
...
# ── 7. Portfolio Optimization using Efficient Frontier ─────────────────────

from pypfopt.efficient_frontier import EfficientFrontier
from pypfopt import risk_models
from pypfopt import expected_returns

# Select stocks from cluster 3 (RSI ~70, momentum cluster)
...
# Download fresh daily prices for shortlisted stocks
...
# ── 8. Visualize Portfolio returns vs SP500 ────────────────────────────────
